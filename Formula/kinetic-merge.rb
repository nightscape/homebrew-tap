class KineticMerge < Formula
  ...
  url "https://github.com/sageserpent-open/kineticMerge/releases/download/v1.6.11/kinetic-merge"

  sha256 "795ec42f22577b2b876e8a4993615f00f10309db6289b5488212628e639ef440"
